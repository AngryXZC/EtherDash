...
<%-- 	                                        <td>${item.item_price }</td> --%>
	                                                ...
	                                                <td data-value="1">
	                                                	...
	                                                	<a herf="#"  id="del_btn" class="btn btn-xs btn-warning" onclick="restFul('${item.item_id}')">ajax</a>
	                                                </td>
	                                           	</tr>
                                        	</c:forEach>
                                        </tbody>
                    ...
                    <ul>
                        <li class="first_level">
                            ...
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath }/item/allList.do">游戏列表</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
